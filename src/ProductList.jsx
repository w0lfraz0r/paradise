...
function ProductList() {
	...
	const cartTotalQuantity = useSelector((state) => state.cart.totalQuantity) // Access total quantity
	...
	const handleAddToCart = (product) => {
		console.log("Adding to cart:", product) // Verifique se o produto está sendo passado
